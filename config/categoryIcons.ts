...
export const SUBCATEGORY_ICONS: Record<string, any> = {
  ...
  'meat-fish': require('@/assets/category-icons/GROCERY-ESSENTIALS/Fresh-vegetables.png'),
  'dairy': require('@/assets/category-icons/GROCERY-ESSENTIALS/Dairy.png'),
  'packaged-goods': require('@/assets/category-icons/GROCERY-ESSENTIALS/Supermarkets.png'),
  ...
  'cosmetology': require('@/assets/category-icons/BEAUTY-WELLNESS/Cosmetology.png'),
  'dermatology': require('@/assets/category-icons/BEAUTY-WELLNESS/Dermatology.png'),
  'skincare-cosmetics': require('@/assets/category-icons/BEAUTY-WELLNESS/Cosmetology.png'),
  ...
  'bags-accessories': require('@/assets/category-icons/Shopping/Fashion.png'),
  'electronics': require('@/assets/category-icons/Shopping/Electronics.png'),
