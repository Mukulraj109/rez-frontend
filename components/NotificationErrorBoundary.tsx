...
// Catches and handles errors in notification-related components
      ...
      return (
        <View style={styles.errorContainer}>
          <View style={styles.errorContent}>
            ...
            <Text style={styles.errorTitle}>Notification Error</Text>
            <Text style={styles.errorMessage}>
              Something went wrong with the notification system. Please try again.
            </Text>
