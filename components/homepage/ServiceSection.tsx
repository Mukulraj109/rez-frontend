      ...
      >
          ...
          <View style={styles.listImageContainer}>
            {displayImage ? (
              ...
              <View style={styles.listImagePlaceholder}>
                <Ionicons name="construct-outline" size={32} color={SERVICE_COLORS.textMuted} />
              </View>
            )}
          </View>
          {isBestSeller && (
        ...
        <View style={styles.listItemContent}>
          ...
          <Text style={styles.listItemSubtitle} numberOfLines={1}>
            {store.category.length > 0 ? store.category.slice(0, 2).join(' • ') : 'Service'}
          </Text>
...
const styles = StyleSheet.create({
  ...
  categoryChipActive: {
    borderBottomColor: SERVICE_COLORS.primary,
  },
  categoryChipText: {
    fontSize: 14,
    fontWeight: '500',
