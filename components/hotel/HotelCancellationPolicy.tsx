/**
 * Hotel Cancellation Policy - Displays cancellation terms
 */
...
const HotelCancellationPolicy: React.FC<HotelCancellationPolicyProps> = ({ policy }) => {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.policyCard}>
        ...
        <Text style={styles.policyText}>
          Cancel {policy.cancellationDeadline} hours before check-in for a {policy.refundPercentage}% refund.
        </Text>
