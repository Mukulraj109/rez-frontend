/**
 * Fashion Category Page - ENHANCED v2
...
import {
  ...
  fashionBankOffers,
  fashionQuickFilters,
} from '@/data/category/fashionCategoryData';
...
export default function FashionCategoryPage() {
  ...
  if (isLoading && !refreshing && subcategories.length === 0) {
    return (
      <LoadingState message="Loading fashion collection..." />
    );
  }
  ...
  return (
    <ErrorBoundary onError={(err) => console.error('[FashionPage] Error:', err)}>
    <ScrollView
    ...
    >
      ...
      <View style={styles.loyaltyHub}>
        <LinearGradient
          colors={['rgba(139, 92, 246, 0.15)', 'rgba(59, 130, 246, 0.1)', 'rgba(251, 191, 36, 0.1)']}
        ...
        >
          <View style={styles.loyaltyHubHeader}>
            ...
            <View style={styles.loyaltyHubText}>
              <Text style={styles.loyaltyHubTitle}>Fashion Loyalty Hub</Text>
              <Text style={styles.loyaltyHubSubtitle}>Track purchases, unlock style rewards</Text>
            </View>
          ...
          <View style={styles.loyaltyHubStats}>
            <View style={styles.loyaltyHubStat}>
              ...
              <Text style={styles.loyaltyHubStatValue}>15</Text>
            </View>
            <View style={styles.loyaltyHubStat}>
              <Text style={styles.loyaltyHubStatLabel}>Active Brands</Text>
              <Text style={[styles.loyaltyHubStatValue, { color: COLORS.purple }]}>4</Text>
            </View>
            <View style={styles.loyaltyHubStat}>
      ...
      <View style={styles.quickFiltersContainer}>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.quickFilters}>
          {fashionQuickFilters.slice(0, 7).map((filter) => (
            <TouchableOpacity
              key={filter.id}
              style={[
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <View style={styles.sectionTitleRow}>
              ...
              <Text style={styles.sectionSubtitle}>What's your mood today?</Text>
            </View>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <View style={styles.sectionTitleRow}>
              ...
              <Text style={styles.sectionSubtitle}>Get ready for your events</Text>
            </View>
        ...
        >
          <View style={styles.tryBuyContent}>
            ...
            <View style={styles.tryBuyText}>
              <Text style={styles.tryBuyTitle}>60-min Try & Buy</Text>
              <Text style={styles.tryBuySubtitle}>Try at home, pay if you love it</Text>
            </View>
            <TouchableOpacity style={styles.tryBuyButton} onPress={() => router.push(`/stores?category=${slug}&filter=try-buy`)}>
        ...
        >
          <View style={styles.compareHeader}>
            ...
            <View style={styles.compareText}>
              ...
              <Text style={styles.compareSubtitle}>Compare prices across Myntra, Ajio, Amazon</Text>
            </View>
          </View>
