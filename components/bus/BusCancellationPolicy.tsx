/**
 * Bus Cancellation Policy - Displays cancellation terms
 */
...
interface BusCancellationPolicyProps {
  policy: CancellationPolicy;
}

const BusCancellationPolicy: React.FC<BusCancellationPolicyProps> = ({ policy }) => {
  return (
      ...
      <View style={styles.policyCard}>
        <View style={styles.policyHeader}>
          <Ionicons 
            ...
            size={24} 
            color={policy.freeCancellation ? '#F97316' : '#EF4444'} 
          />
...
export default BusCancellationPolicy;
