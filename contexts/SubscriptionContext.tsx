...
export function SubscriptionProvider({ children }: SubscriptionProviderProps) {
  ...
  // Computed values
  const isSubscribed = state.currentSubscription?.tier !== 'free' && state.currentSubscription?.status === 'active';
  const isPremium = state.currentSubscription?.tier === 'premium' && state.currentSubscription?.status === 'active';
  const isVIP = state.currentSubscription?.tier === 'vip' && state.currentSubscription?.status === 'active';
