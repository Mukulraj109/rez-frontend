...
class ProductCacheService {
  ...
  constructor(options: CacheOptions = {}) {
    ...
    console.log('📦 [ProductCache] Initialized with maxSize:', this.maxSize, 'ttl:', this.ttl);
  }
  ...
  get<T>(key: string): T | null {
    ...
    if (now - entry.timestamp > this.ttl) {
      console.log('⏰ [ProductCache] Cache expired for key:', key);
    ...
    this.recordHit();
    console.log('✅ [ProductCache] Cache hit for key:', key);
  ...
  set<T>(key: string, data: T): void {
    ...
    console.log('💾 [ProductCache] Cached key:', key, 'size:', this.cache.size);
  }
  ...
  delete(key: string): boolean {
    ...
    this.updateSize();
    console.log('🗑️ [ProductCache] Deleted key:', key);
    return result;
  }
  ...
  invalidate(pattern: string | RegExp): number {
    ...
    this.updateSize();
    console.log(`🔄 [ProductCache] Invalidated ${count} entries matching:`, pattern);
  ...
  private evictLRU(): void {
    ...
    if (lruKey) {
      ...
      console.log('🚮 [ProductCache] Evicted LRU entry:', lruKey);
    }
  }
  ...
  cleanup(): number {
    ...
    this.updateSize();
    console.log(`🧹 [ProductCache] Cleaned up ${count} expired entries`);
  ...
  resetStats(): void {
    ...
    console.log('📊 [ProductCache] Stats reset');
  }
  ...
  setTTL(ttl: number): void {
    this.ttl = ttl;
    console.log('⏱️ [ProductCache] TTL updated to:', ttl);
  }
}
