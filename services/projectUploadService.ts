...
export const uploadProjectFile = async (
  ...
  try {
    console.log(`📤 [PROJECT UPLOAD] Uploading ${fileType}: ${fileUri}`);
    ...
    if (response.success && response.data) {
      console.log(`✅ [PROJECT UPLOAD] ${fileType} uploaded successfully`);
      return {
        success: true,
    ...
    console.error(`❌ [PROJECT UPLOAD] Error uploading ${fileType}:`, error);
    return {
      success: false,
...
export const uploadMultipleProjectFiles = async (
  ...
  try {
    console.log(`📤 [PROJECT UPLOAD] Uploading ${fileUris.length} ${fileType}(s)`);
    ...
    if (response.success && response.data) {
      console.log(`✅ [PROJECT UPLOAD] ${response.data.count} file(s) uploaded successfully`);
    ...
    console.error(`❌ [PROJECT UPLOAD] Error uploading files:`, error);
    return fileUris.map(() => ({
      success: false,
