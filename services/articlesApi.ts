...
class ArticlesService {
  ...
  async getArticles(params?: ArticlesQuery): Promise<ApiResponse<ArticlesResponse>> {
    try {
      console.log('📰 [Articles API] Getting articles with params:', params);
      return await apiClient.get('/articles', params);
    } catch (error) {
      console.error('❌ [Articles API] Error getting articles:', error);
      throw error;
    }
  }
  ...
  async getArticleById(articleId: string): Promise<ApiResponse<Article>> {
    try {
      console.log(`📰 [Articles API] Getting article by ID: ${articleId}`);
      return await apiClient.get(`/articles/${articleId}`);
    } catch (error) {
      console.error(`❌ [Articles API] Error getting article ${articleId}:`, error);
      throw error;
    }
  }
  ...
  async getArticlesByCategory(
    ...
    try {
      console.log(`📰 [Articles API] Getting articles by category: ${category}`);
      return await apiClient.get(`/articles/category/${category}`, params);
    } catch (error) {
      console.error(`❌ [Articles API] Error getting articles by category ${category}:`, error);
      throw error;
    }
  }
  ...
  async getArticlesByAuthor(
    ...
    try {
      console.log(`📰 [Articles API] Getting articles by author: ${authorId}`);
      return await apiClient.get(`/articles/author/${authorId}`, params);
    } catch (error) {
      console.error(`❌ [Articles API] Error getting articles by author ${authorId}:`, error);
      throw error;
    }
  }
  ...
  async getTrendingArticles(
    ...
    try {
      console.log(`📰 [Articles API] Getting trending articles (limit: ${limit}, timeframe: ${timeframe})`);
      return await apiClient.get('/articles/trending', { limit, timeframe });
    } catch (error) {
      console.error('❌ [Articles API] Error getting trending articles:', error);
      throw error;
    }
  }
  ...
  async getFeaturedArticles(limit: number = 10): Promise<ApiResponse<Article[]>> {
    try {
      console.log(`📰 [Articles API] Getting featured articles (limit: ${limit})`);
      return await apiClient.get('/articles/featured', { limit });
    } catch (error) {
      console.error('❌ [Articles API] Error getting featured articles:', error);
      throw error;
    }
  }
  ...
  async searchArticles(
    ...
    try {
      console.log(`📰 [Articles API] Searching articles with query: "${query}"`);
      return await apiClient.get('/articles/search', {
        search: query,
        ...filters
      });
    } catch (error) {
      console.error('❌ [Articles API] Error searching articles:', error);
      throw error;
    }
  }
  ...
  async createArticle(articleData: ArticleInput): Promise<ApiResponse<Article>> {
    try {
      console.log('📰 [Articles API] Creating new article:', articleData.title);
  ...
  async updateArticle(
    ...
    try {
      console.log(`📰 [Articles API] Updating article: ${articleId}`);
      ...
      console.error(`❌ [Articles API] Error updating article ${articleId}:`, error);
      throw error;
    }
  }
  ...
  async deleteArticle(articleId: string): Promise<ApiResponse<{ message: string }>> {
    try {
      console.log(`📰 [Articles API] Deleting article: ${articleId}`);
      return await apiClient.delete(`/articles/${articleId}`);
    } catch (error) {
      console.error(`❌ [Articles API] Error deleting article ${articleId}:`, error);
      throw error;
    }
  }
  ...
  async toggleArticleLike(
    ...
    try {
      console.log(`📰 [Articles API] Toggling like for article: ${articleId}`);
      return await apiClient.post(`/articles/${articleId}/like`);
    } catch (error) {
      console.error(`❌ [Articles API] Error toggling like for article ${articleId}:`, error);
      throw error;
    }
  }
  ...
  async toggleArticleBookmark(
    ...
    try {
      console.log(`📰 [Articles API] Toggling bookmark for article: ${articleId}`);
      return await apiClient.post(`/articles/${articleId}/bookmark`);
    } catch (error) {
      console.error(`❌ [Articles API] Error toggling bookmark for article ${articleId}:`, error);
      throw error;
    }
  }
  ...
  async getBookmarkedArticles(
    ...
    try {
      console.log('📰 [Articles API] Getting bookmarked articles');
      return await apiClient.get('/articles/bookmarks', { page, limit });
    } catch (error) {
      console.error('❌ [Articles API] Error getting bookmarked articles:', error);
      throw error;
    }
  }
  ...
  async shareArticle(
    ...
    try {
      console.log(`📰 [Articles API] Sharing article: ${articleId} on ${platform || 'unknown'}`);
      return await apiClient.post(`/articles/${articleId}/share`, { platform });
    } catch (error) {
      console.error(`❌ [Articles API] Error sharing article ${articleId}:`, error);
      throw error;
    }
  }
  ...
  async recordView(
    ...
    try {
      console.log(`📰 [Articles API] Recording view for article: ${articleId}`);
      return await apiClient.post(`/articles/${articleId}/view`, { readTime });
    } catch (error) {
      console.error(`❌ [Articles API] Error recording view for article ${articleId}:`, error);
      throw error;
    }
  }
  ...
  async getArticleEngagement(
    ...
    try {
      console.log(`📰 [Articles API] Getting engagement for article: ${articleId}`);
      return await apiClient.get(`/articles/${articleId}/engagement`);
    } catch (error) {
      console.error(`❌ [Articles API] Error getting engagement for article ${articleId}:`, error);
      throw error;
    }
  }
  ...
  async getArticleComments(
    ...
    try {
      console.log(`📰 [Articles API] Getting comments for article: ${articleId}`);
      ...
      console.error(`❌ [Articles API] Error getting comments for article ${articleId}:`, error);
      throw error;
    }
  }
  ...
  async addArticleComment(
    ...
    try {
      console.log(`📰 [Articles API] Adding comment to article: ${articleId}`);
      return await apiClient.post(`/articles/${articleId}/comments`, {
        content,
        parentId
      });
    } catch (error) {
      console.error(`❌ [Articles API] Error adding comment to article ${articleId}:`, error);
      throw error;
    }
  }
  ...
  async getRelatedArticles(
    ...
    try {
      console.log(`📰 [Articles API] Getting related articles for: ${articleId}`);
      return await apiClient.get(`/articles/${articleId}/related`, { limit });
    } catch (error) {
      console.error(`❌ [Articles API] Error getting related articles for ${articleId}:`, error);
      throw error;
    }
  }
  ...
  async getRecommendedArticles(
    ...
    try {
      console.log('📰 [Articles API] Getting recommended articles');
      return await apiClient.get('/articles/recommendations', { limit });
    } catch (error) {
      console.error('❌ [Articles API] Error getting recommended articles:', error);
      throw error;
    }
  }
  ...
  async getArticleCategories(): Promise<ApiResponse<Array<{
    ...
    try {
      console.log('📰 [Articles API] Getting article categories');
      return await apiClient.get('/articles/categories');
    } catch (error) {
      console.error('❌ [Articles API] Error getting article categories:', error);
      throw error;
    }
  }
  ...
  async reportArticle(
    ...
    try {
      console.log(`📰 [Articles API] Reporting article: ${articleId} for ${reason}`);
      return await apiClient.post(`/articles/${articleId}/report`, {
        reason,
        details
      });
    } catch (error) {
      console.error(`❌ [Articles API] Error reporting article ${articleId}:`, error);
      throw error;
    }
  }
}
