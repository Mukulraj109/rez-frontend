...
class GamificationCacheService {
  ...
  private async getWithMemoryCache<T>(
    ...
    if (memoryCached && Date.now() - memoryCached.timestamp < this.MEMORY_CACHE_TTL) {
      console.log(`⚡ [GAMIFICATION_CACHE] Memory cache hit: ${key}`);
  ...
  invalidateLeaderboard = debounce(async (period?: string) => {
    ...
    console.log('💾 [GAMIFICATION_CACHE] Leaderboard invalidated');
  ...
  async invalidateAchievements(userId: string): Promise<void> {
    ...
    console.log('💾 [GAMIFICATION_CACHE] Achievements invalidated');
  }
  ...
  invalidateChallenges = throttle(async () => {
    ...
    console.log('💾 [GAMIFICATION_CACHE] Challenges invalidated');
  ...
  async invalidateStats(): Promise<void> {
    ...
    this.clearMemoryCache(key);
    await cacheService.remove(key);
    console.log('💾 [GAMIFICATION_CACHE] Stats invalidated');
  }
  ...
  invalidateCoinBalance = debounce(async () => {
    ...
    this.clearMemoryCache(key);
    await cacheService.remove(key);
    console.log('💾 [GAMIFICATION_CACHE] Coin balance invalidated');
  ...
  async clearAll(): Promise<void> {
    console.log('🧹 [GAMIFICATION_CACHE] Clearing all gamification caches...');
    ...
    console.log('✅ [GAMIFICATION_CACHE] All caches cleared');
  }
  ...
  async preload(
    ...
    console.log('🚀 [GAMIFICATION_CACHE] Preloading gamification data...');
    ...
    console.log('✅ [GAMIFICATION_CACHE] Preload complete');
  }
}
