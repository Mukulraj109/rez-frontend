...
const BANKS: Bank[] = [
  { id: '1', name: 'HDFC Bank', logo: '🏦', noCostTenures: [3, 6], processingFee: '₹199' },
  { id: '2', name: 'ICICI Bank', logo: '🏛️', noCostTenures: [3, 6, 9], processingFee: '₹299' },
  { id: '3', name: 'SBI Card', logo: '🏦', noCostTenures: [3], processingFee: '₹199' },
  { id: '4', name: 'Axis Bank', logo: '🏛️', noCostTenures: [3, 6, 12], processingFee: '₹249' },
  { id: '5', name: 'Kotak Bank', logo: '🏦', noCostTenures: [3, 6], processingFee: '₹199' },
  { id: '6', name: 'AMEX', logo: '💳', noCostTenures: [3], processingFee: '₹499' },
];
                  ...
                  >
                    ...
                    {!option.isNoCost && (
                      <ThemedText style={styles.tenureInterest}>
                        Interest: ₹{option.interest.toLocaleString()}
                      </ThemedText>
                    )}
                  </TouchableOpacity>
                );
            ...
            <View style={styles.summaryRow}>
              ...
              <ThemedText style={styles.summaryValue}>
                {calculateEMI(selectedTenure, selectedBank).isNoCost
                  ? 'No Interest'
                  : `₹${calculateEMI(selectedTenure, selectedBank).interest.toLocaleString()}`}
              </ThemedText>
            </View>
            ...
            <View style={[styles.summaryRow, styles.summaryTotal]}>
              ...
              <ThemedText style={styles.summaryTotalValue}>
                ₹{(calculateEMI(selectedTenure, selectedBank).total +
                  parseInt(selectedBank.processingFee.replace(/[₹,]/g, ''))).toLocaleString()}
              </ThemedText>
            </View>
          </View>
        )}
